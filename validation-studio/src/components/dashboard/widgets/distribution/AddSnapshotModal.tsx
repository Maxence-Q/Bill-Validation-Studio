...
export interface AddDistributionSnapshotModalProps {
    open: boolean
...
export function AddDistributionSnapshotModal({
    open,
    onOpenChange,
    defaultCount,
    onSubmit,
}: AddDistributionSnapshotModalProps) {
            ...
            <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handleSubmit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Capture a new distribution pie chart from the latest evaluations.
                        </DialogDescription>
                    </DialogHeader>
